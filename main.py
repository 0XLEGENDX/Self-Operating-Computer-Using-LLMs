from modules.vlm import llm
from modules.voice import voice

from modules.screenshot import screenshot
from modules.input import keyboard
from modules.input import mouse
import json
import time
from modules.voice.stt import recognize_speech 
...
while(True):
    ...
    for action in action_steps:
        print("INFO LLMDesk Task Executing: ",action)
        task = action["intent"]
